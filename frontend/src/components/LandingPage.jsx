  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F7F7F5', fontFamily: "'Inter', sans-serif" }}>
      ...
      <nav style={{
        ...
        <span style={{ fontWeight: 700, fontSize: '18px', letterSpacing: '-0.3px' }}>HandScript</span>
      ...
      <section style={{ maxWidth: '860px', margin: '0 auto', padding: '72px 24px 48px', textAlign: 'center' }}>
        ...
        <p style={{
          ...
          HandScript reads it and gives you clean, editable text in seconds.
        </p>
        <button onClick={onGetStarted} style={{
      ...
      <section style={{ maxWidth: '820px', margin: '0 auto 64px', padding: '0 24px' }}>
        <div style={{
          ...
          <img src="/hero.jpg" alt="HandScript in action" style={{ width: '100%', display: 'block' }} />
        </div>
      </section>
      ...
      <footer style={{
        ...
        © {new Date().getFullYear()} HandScript
      </footer>
    </div>
  );
}
