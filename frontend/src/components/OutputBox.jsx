...
export default function OutputBox({ text, sessionId, onReset }) {
    ...
    return (
        <div style={{ animation: 'fadeIn 0.4s ease' }}>
            ...
            {/* Email row — always visible, no expand needed */}
            <div style={{
            ...
            <div style={{
                ...
                {/* Footer */}
                <div style={{
                    padding: '8px 14px', borderTop: '1px solid #F5F4F0',
                    background: '#FAFAF9', display: 'flex', justifyContent: 'space-between'
                }}>
                    <span style={{ fontSize: '11px', color: '#D6D3CE', fontStyle: 'italic' }}>Tap to edit</span>
