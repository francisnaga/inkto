...
const LOADING_STEPS = [
    { icon: '­ƒöì', text: 'Scanning document structure...' },
    { icon: 'Ô£ì´©Å', text: 'Analysing handwriting patterns...' },
    { icon: 'ÔÜû´©Å', text: 'Applying legal document rules...' },
    { icon: 'Ô£é´©Å', text: 'Removing crossed-out text...' },
    { icon: '­ƒôØ', text: 'Drafting initial transcript...' },
    { icon: '­ƒöì', text: 'Verifying numbers and proper nouns...' },
    { icon: 'Ô£¿', text: 'Finalising transcript...' },
];
        ...
        <div style={{ animation: 'fadeIn 0.35s ease' }}>
            ...
            <div style={{
                ...
                <p style={{ fontSize: '12px', color: '#C4C4C4', margin: 0 }}>
                    {elapsed < 5 ? 'Starting...' : `${elapsed}s elapsed ┬À ${estimateSecs}`}
                </p>
            </div>
...
function App() {
    ...
    const isSessionPath = cleanPath.startsWith('/session/');
            ...
            <main>
                {showHistory ? (
                    ...
                    <>
                                    ...
                                    <div style={{ marginTop: '18px' }}>
                                        ...
                                        <div style={{ marginTop: '16px' }}>
                                            <div style={{
                                                ...
                                                <input
                                                    type="text"
                                                    placeholder='e.g. "This is a Lagos State affidavit ÔÇö note 2 exhibits at the back"'
                                                    value={customPrompt}
                                        ...
                                        >
                                            ...
                                            Transcribe {files.length} {files.length === 1 ? 'Page' : 'Pages'} ÔåÆ
                                        </button>
                                    </div>
                                )}
                            </div>
                        ...
                        {/* ÔöÇÔöÇ Sleeker Fetching Animation ÔöÇÔöÇ */}
